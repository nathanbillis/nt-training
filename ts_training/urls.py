...
urlpatterns = [
    ...
    url(r'^people/(?P<slug>[\w\-]+)/$',
        views.PersonView.as_view(), name='ntPerson'),

    # Training Spec Views
    # /training
    url(r'^training/$', views.TrainingView.as_view(), name='ntCategory'),
    # /training/id
    url(r'^training/(?P<pk>[0-9]+)/$',
        views.TrainingDetailView.as_view(), name='ntTrainingDetail'),
    ...
    url(r'^training/session/(?P<pk>[0-9]+)/$',
        views.SessionSingleView.as_view(), name='ntSessionSingle'),
    ...
    url(r'^training/session/(?P<pk>[0-9]+)/edit/$',
        views.SessionEditView.as_view(), name='ntSessionEdit'),

    # /training/plan (List view)
    url(r'^training/plan/$', views.PlanView.as_view(), name='ntPlan'),
    # /training/plan/id (single View)
    url(r'^training/plan/(?P<pk>[0-9]+)/$',
        views.PlanSingleView.as_view(), name='ntPlanSingle'),

    # /training/plan/new
    url(r'^training/plan/new/$', views.PlanNewView.as_view(), name='ntPlanNew'),
    # /training/plan/id/edit
    url(r'^training/plan/(?P<pk>[0-9]+)/edit/$',
        views.PlanEditView.as_view(), name='ntPlanEdit'),

    # /training/plan/signup
    url(r'^training/plan/signup/(?P<pk>[0-9]+)/$',
        views.SignupView.as_view(), name='ntSignup'),
