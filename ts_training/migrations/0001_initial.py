    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trainee', models.ManyToManyField(related_name='trainee', to='ts_training.Person')),
                ('trainer', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='trainer', to='ts_training.Person')),
            ],
        ),
        migrations.CreateModel(
            name='Training_Spec',
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ts_training.Icon')),
            ],
        ),
        migrations.AddField(
