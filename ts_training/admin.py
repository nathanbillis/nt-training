...
class PersonChangeForm(forms.ModelForm):
    ...
    class Meta:
        model = Person
        fields = ('email', 'password', 'first_name', 'last_name', 'grad_year',
                  'committee', 'status', 'slug', 'is_active', 'is_admin')
...
class TrainingSpecAdmin(admin.ModelAdmin):
    ...
    list_display = ['trainingId', 'category',
                    'trainingTitle', 'description', 'safety']
